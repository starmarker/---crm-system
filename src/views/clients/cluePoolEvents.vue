    ...
    <div class="layout-content">
        <div class="layout-breadcrumb">
            <p class="main-title">
                ...
                <span class="main-title-text">公海池线索</span></p>
            
        </div>
        <div class="layout-content-main">
            <div class="item-block-title clients-title">
                <Button  :class="['title-button',{'current-clicked':changeNum==1}]" @click="outofdateClue">自动回收线索</Button>
                <Button  :class="['title-button',{'current-clicked':changeNum==2}]" @click="effectiveClue">有效的线索</Button>
                <Button  :class="['title-button',{'current-clicked':changeNum==3}]" @click="invalidClue">无效的线索</Button>
                <Button  :class="['title-button',{'current-clicked':changeNum==4}]" @click="allClue">刷新</Button>
            </div>
            <div class="item-block">
                    ...
                    <Table :columns="tableHeader" :data="tableData" show-footer :height="tableHeight" @on-selection-change="getSelectedData" style="float:left;">
                       ...
                       <Page :total="total" :current="pageCurrent" style="float:right;margin-right:20px;display:table;" show-total slot="footer"></Page>                        
                    </Table>
    ...
    export default {
        ...
        methods: {
            ...
            lockMessage() {
                this.$Modal.confirm({
                    ...
                    onOk: () => {
                        ...
                        this.$http.post("/web/Crm_corp_mgr_std_clue/updateCrm_corp_mgr_std_clue_poolMessage", obj).then((res) => {
                            if (res.data.b) {
            ...
            subChangePerson() {
                ...
                this.$http.post("/web/Crm_corp_mgr_std_clue/addAllotCrm_corp_mgr_std_clue_poolMessage", this.turnClue).then((res) => {
                    if (res.data.b) {
                        this.$Message.success('操作成功');
                        this.getHeader();
                        ...
                        if (res.data.i == 1) {
                                this.$Message.warning("有线索处于锁定状态，不能分派");
                        }else {
                            this.$Message.error('操作失败');
                        }
            ...
            turnItem() {
                this.$Modal.confirm({
                    ...
                    onOk: () => {
                        ...
                        this.$http.post("/web/Crm_corp_mgr_std_clue/addCrm_corp_mgr_std_clue_poolMessage", obj).then((res) => {
                            if (res.data.b == 1) {
                                this.$Message.success('操作成功');
                                this.selectedArr = [];
                                this.getHeader();
            ...
            subAddData() {
                this.$refs.addForm.validate(valid => {
                    if (valid) {
                        ...
                        if (this.state == 1) { //添加
                            this.$http.post("/web/Crm_corp_mgr_std_clue/addCrm_corp_mgr_std_clue_pool", this.addClue).then((res) => {
            ...
            getHeader() {
                ...
                this.$http.post("/web/Crm_corp_mgr_std_clue/findCrm_corp_mgr_std_clue_poolList", this.clue).then((res) => {
            ...
            addItem() {
                ...
                //查询添加线索布局
                this.$http.post("/web/Crm_corp_mgr_std_clue/findCrm_corp_mgr_std_clue_poolById", this.additems).then((res) => {
                    this.items = res.data.operationParamsItem.backInfoList;
                    let items = JSON.parse(JSON.stringify(res.data.operationParamsItem.backInfoList));
                    this.creatAddObj(this.addObj, items);
                    //this.creatAddObj(this.$refs.addForm.cObj, items);
                    this.createAddRules(this.addRules, items);
            ...
            outofdateClue() {
                this.changeNum = 1;
                this.clue.operationParamsItem.pi = 1;
                this.$http.post("/web/Crm_corp_mgr_std_clue/findOutofdateCrm_corp_mgr_std_clue_poolList", this.clue).then((res) => {
                    if (res.data.operationParamsItem.isSuccess == 1) {
                        this.showTableColumns = res.data.operationParamsItem.backInfoList.field_name;
                        this.tableData = res.data.operationParamsItem.backInfoList.field_value;
                        this.total = res.data.operationParamsItem.page.total;
            ...
            effectiveClue() {
                this.changeNum = 2;
                this.clue.operationParamsItem.pi = 1;
                this.$http.post("/web/Crm_corp_mgr_std_clue/findEffectiveCrm_corp_mgr_std_clue_poolList", this.clue).then((res) => {
                    if (res.data.operationParamsItem.isSuccess == 1) {
                        this.showTableColumns = res.data.operationParamsItem.backInfoList.field_name;
                        this.tableData = res.data.operationParamsItem.backInfoList.field_value;
                        this.total = res.data.operationParamsItem.page.total;
            ...
            invalidClue() {
                this.changeNum = 3;
                this.clue.operationParamsItem.pi = 1;
                this.$http.post("/web/Crm_corp_mgr_std_clue/findInvalidCrm_corp_mgr_std_clue_poolList", this.clue).then((res) => {
                    if (res.data.operationParamsItem.isSuccess == 1) {
                        this.showTableColumns = res.data.operationParamsItem.backInfoList.field_name;
                        this.tableData = res.data.operationParamsItem.backInfoList.field_value;
                        this.total = res.data.operationParamsItem.page.total;
            ...
            changePage(c) {
                let url = "";
                if (this.changeNum == 1) {
                    url = "/web/Crm_corp_mgr_std_clue/findOutofdateCrm_corp_mgr_std_clue_poolList";
                } else if (this.changeNum == 2) {
                    url = "/web/Crm_corp_mgr_std_clue/findEffectiveCrm_corp_mgr_std_clue_poolList";
                } else if (this.changeNum == 3) {
                    url = "/web/Crm_corp_mgr_std_clue/findInvalidCrm_corp_mgr_std_clue_poolList";
                } else if (this.changeNum == 4) {
                    url = "/web/Crm_corp_mgr_std_clue/findCrm_corp_mgr_std_clue_poolList";
                }
